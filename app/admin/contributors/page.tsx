    ...
    <main className="admin-page">
      <div className="admin-shell admin-contributors">
        <header className="admin-header">
          ...
          <div className="admin-actions"><a href="/admin/email">Email</a><a href="/admin/preorders">Pre-orders</a><a href="/admin/waitlist">Subscribers</a><a className="text-link" href={chatGPTSignOutPath("/")}>Sign out</a></div>
        </header>
