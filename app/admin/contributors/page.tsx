    ...
    <main className="admin-page">
      <div className="admin-shell admin-contributors">
        <header className="admin-header">
          ...
          <div className="admin-actions"><a href="/admin/waitlist">Waitlist</a><a href="/admin/preorders">Pre-orders</a><a className="text-link" href={chatGPTSignOutPath("/")}>Sign out</a></div>
        </header>
