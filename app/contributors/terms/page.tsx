    ...
    <main className="legal-page">
      <article className="legal-shell">
        ...
        <section>
          ...
          <p>
            Membership includes a contributor number and badge, monthly development updates, a weekly asynchronous founder Q&A, quarterly group briefings or demonstrations, selected advisory votes, and priority consideration for appropriately consented research opportunities. Specific dates and formats may change while Frame remains in development.
          </p>
        </section>
        <section>
