...
export function ContributorSuccess() {
  ...
  const profileHref = preview
    ? "/contributors/onboarding?preview=1"
    : "/contributors/sign-in?next=onboarding";
  const hubHref = preview ? "/contributors?preview=1" : "/contributors/sign-in";
  return (
    <section className="contributor-success" role="status" aria-live="polite">
      ...
      <ol className="contributor-success__steps">
        <li><span>01</span><strong>Complete your member profile</strong></li>
        <li><span>02</span><strong>Enter the contributor hub</strong></li>
      ...
      <div className="contributor-success__actions">
        <Link className="button button--dark" href={profileHref}>Complete your profile</Link>
        <Link className="text-link" href={hubHref}>Enter the contributor hub</Link>
      </div>
