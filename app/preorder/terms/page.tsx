  ...
  return (
    <main className="legal-page">
      ...
      <article className="legal-shell">
        ...
        <section><h2>4. Price, tax and shipping</h2><p>The current $299 USD amount is a test offer only. Final price, tax treatment, shipping cost and supported regions must be confirmed before launch.</p></section>
        <section><h2>5. Delivery and delays</h2><p>The current estimated delivery date is January 1, 2027. This estimate is not guaranteed and may change as development, approval, manufacturing and fulfilment planning progress. <strong>[APPROVED DELAY NOTICE PROCESS, CUSTOMER CHOICES AND CANCELLATION RIGHTS TO BE INSERTED]</strong></p></section>
