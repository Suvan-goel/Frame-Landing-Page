...
export type FrameRuntimeEnv = {
  ...
  FRAME_RESERVATION_PRICE_CENTS?: string;
  ...
  STRIPE_RESERVATION_PRICE_ID?: string;
  STRIPE_TEST_RESERVATION_PRICE_ID?: string;
  STRIPE_LIVE_RESERVATION_PRICE_ID?: string;
  ...
  PREORDER_ALLOW_BANK_PENDING_LAUNCH?: string;
