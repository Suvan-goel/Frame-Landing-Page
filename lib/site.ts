import { ORGANIZATION_DISPLAY_NAME } from "./company";

export const SITE_URL = "https://framewearable.com";
export const SITE_NAME = "Frame";
export const ORGANIZATION_NAME = ORGANIZATION_DISPLAY_NAME;
