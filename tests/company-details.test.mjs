...
test("accepts one complete identity and formats it consistently", () => {
  ...
  assert.equal(
    ...
    "Frame Health Technologies, Inc. · Registration 1234567 · Registered in Delaware, United States · 123 Example Street, Suite 400, Wilmington, Delaware, 19801, United States",
  );
});
...
test("wires the same company source through policies, support, emails, and launch checks", async () => {
  ...
  const [terms, refunds, productStatus, privacy, contact, email, emailDesign, readiness] = files;
