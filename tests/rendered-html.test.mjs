...
test("server-renders the Frame landing page", async () => {
  ...
  assert.match(html, /frame-on-arm-editorial-v4-transparent\.png/);
...
test("uses generated raster visuals and keeps the page editable", async () => {
  ...
  assert.match(page, /src="\/frame-on-arm-editorial-v4-transparent\.png"/);
  ...
  assert.deepEqual(
    [
      ...
      "frame-on-arm-editorial-v4-transparent.png",
